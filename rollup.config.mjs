...
export default [
    // ES bundle (the Flitware Base client as default export + additional helper classes).
    {
        input: 'src/index.ts',
        output: [
            {
                file:      'dist/flitware-base.es.mjs',
                format:    'es',
    ...
    // UMD bundle (only the Flitware Base client as default export).
    {
        input: 'src/Client.ts',
        output: [
            {
                name:      'FlitwareBase',
                file:      'dist/flitware-base.umd.js',
                format:    'umd',
                exports:   'default',
                sourcemap: isProduction,
            },
    ...
    // CommonJS bundle (only the Flitware Base client as default export).
    {
        input: 'src/Client.ts',
        output: [
            {
                name:      'FlitwareBase',
                file:      'dist/flitware-base.cjs.js',
                format:    'cjs',
                exports:   'default',
                sourcemap: isProduction,
            }
    ...
    // !!!
    //
    // Browser-friendly iife bundle (only the Flitware Base client as default export).
    {
        input: 'src/Client.ts',
        output: [
            {
                name:      'FlitwareBase',
                file:      'dist/flitware-base.iife.js',
                format:    'iife',
                sourcemap: isProduction,
            },
        ],
