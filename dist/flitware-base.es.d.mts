...
declare module FlitwareBaseWrapper {
    export { FlitwareBase };
}
import Client = FlitwareBaseWrapper.FlitwareBase;
/**
...
import Client$0 = FlitwareBaseWrapper.FlitwareBase;
...
declare class RecordService<M = RecordModel> extends CrudService<M> {
    ...
    constructor(client: Client$0, collectionIdOrName: string);
    /**
     * @inheritdoc
     */
     ...
     * @throws {ClientResponseError}
     */
    impersonate(recordId: string, duration: number, options?: CommonOptions): Promise<Client$0>;
    // ---------------------------------------------------------------
...
/**
 * Flitware Base client.
 *
 * Originally derived from the PocketBase JS Client (see UPSTREAM.md).
 * It preserves the PocketBase JS SDK v0.26.1 behavior and wire protocol.
 */
declare class FlitwareBase {
    /**
     * The base Flitware Base backend url address (eg. 'http://127.0.0.1.8090').
     */
    baseURL: string;
    /**
     ...
     * Example:
     * ```js
     * const pb = new FlitwareBase("https://example.com")
     *
     ...
     */
    autoCancellation(enable: boolean): FlitwareBase;
    /**
     * Cancels single request by its cancellation key.
     */
    cancelRequest(requestKey: string): FlitwareBase;
    /**
     * Cancels all pending requests.
     */
    cancelAllRequests(): FlitwareBase;
    /**
 ...
 * import FlitwareBase, { AsyncAuthStore } from "@flitware/base";
 *
 ...
 * });
 *
 * const pb = new FlitwareBase("https://example.com", store)
 * ```
 */
